...
const Incomes = () => {
    ...
    const { filterdData, filters, setFilter } = useFilterdData({data: incomes, filters: { nombre: '', categoria: undefined }});
    ...
    return (
        <>
            ...
            <Modal isOpen={isModalOpen} onClose={closeModal} onConfirm={() =>{
                if(elementDelete !== undefined) eliminarIngreso(elementDelete)
            } }title={'Eliminar el ingreso'} message={'¿Estas seguro que deseas eliminar el ingreso?'} />
