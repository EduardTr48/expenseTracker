...
const Expense = () => {
    ...
    const { filterdData, filters, setFilter } = useFilterdData({data: expenses, filters: { nombre: '', categoria: undefined }});
    ...
    return (
        <>
            ...
            <Modal isOpen={isModalOpen} onClose={closeModal} onConfirm={() => {
                if(elementDelete !== undefined) eliminarGasto(elementDelete)
                }} title={'Eliminar el gasto'} message={'¿Seguro que deseas elimiar el gasto?'} />
            ...
            <div className="grid grid-cols-3 gap-6">
                ...
                {<FilterSearch filter={filters.nombre} onNameChange={(e : ChangeEvent<HTMLInputElement>) => setFilter('nombre', e.target.value)} />}
